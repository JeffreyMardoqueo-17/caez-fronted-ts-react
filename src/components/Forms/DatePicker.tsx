            ...
            >
                <DayPicker
                    ...
                    classNames={{
                        ...
                        caption_label: "text-sm !font-medium text-gray-900 dark:text-bg-darkTheme-text",
                        nav: "flex items-center",
                        nav_button: "h-6 w-6 bg-transparent hover:bg-blue-gray-50 dark:hover:bg-darkTheme-background p-1 rounded-md transition-colors duration-300",
                        nav_button_previous: "absolute left-1.5",
                        nav_button_next: "absolute right-1.5",
                        table: "w-full border-collapse",
                        head_row: "flex !font-medium text-gray-900 dark:text-bg-darkTheme-text",
                        head_cell: "m-0.5 w-9 !font-normal text-sm",
                        row: "flex w-full mt-2",
                        cell: "text-gray-600 dark:text-bg-darkTheme-gray rounded-md h-9 w-9 text-center text-sm p-0 m-0.5 relative",
                        day: "h-9 w-9 p-0 !font-normal",
                        day_range_end: "day-range-end",
                        day_selected: "rounded-md bg-gray-900 dark:bg-bg-darkTheme-text text-white hover:bg-gray-900 hover:text-white focus:bg-gray-900 focus:text-white",
                        day_today: "rounded-md bg-gray-200 dark:bg-bg-darkTheme-gray text-gray-900 dark:text-bg-darkTheme-text",
