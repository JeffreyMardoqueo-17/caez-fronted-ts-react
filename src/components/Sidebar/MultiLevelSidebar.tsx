...
const menuItems: MenuItem[] = [
    ...
    },
    {
        ...
        submenu: [
            { title: 'Profile', path: '/settings/profile', icon: <ChevronDownIcon className="h-4 w-4" /> },
            { title: 'Billing', path: '/settings/billing', icon: <ChevronDownIcon className="h-4 w-4" /> },
        ],
    },
    { title: 'Reports', icon: <InboxIcon className="h-6 w-6" />, path: '/reports' },
                            ...
                            <li key={index} className="group">
                                <div
                                    ...
                                    className={`flex items-center p-3 rounded-md cursor-pointer transition-colors duration-300 group-hover:bg-gray-100 dark:group-hover:bg-gray-800 
                                        ${isActive || hasActiveSubmenu ? 'bg-gray-200 dark:bg-gray-700 text-purple-500' : 'text-gray-600 dark:text-gray-400'}`}
                                >
